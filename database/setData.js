...
function readData(){
    ...
    rootRef.on("value", function(snapshot) {
        ...
        document.getElementById("keitaibango1").textContent = keitaibangoary[0];
        document.getElementById("keitaibango2").textContent = keitaibangoary[1];
        document.getElementById("keitaibango3").textContent = keitaibangoary[2];
        ...
        document.getElementById("renrakusaki_denwabango1").textContent = renrakusaki_denwabangoary[0];
        document.getElementById("renrakusaki_denwabango2").textContent = renrakusaki_denwabangoary[1];
        document.getElementById("renrakusaki_denwabango3").textContent = renrakusaki_denwabangoary[2];
